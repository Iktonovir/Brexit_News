...
/**
 * Helper methods related to requesting and receiving Brexit articles from The Guardian.
 */
final class QueryUtils {
    ...
    /**
     * Return a list of {@link News} objects that have been built up from parsing the given JSON
     * response
     *
            ...
            if (baseJsonResponse.has("response")) {
                ...
                if (responseObj.has("results")) {
                    ...
                    for (int i = 0; i < newsArray.length(); i++) {
                        ...
                        News news = new News(imgUrl, webTitle, sectionName, author, webDate, webUrl);
                        articles.add(news);
                    }
                }
            }
